# Devlog 11 - More debugging tools! (mostly)
...
The reason why this happens is because 16 (my chunk size) can be multplied and divided by 0.125 (2^-3) evenly to create an integer, compared to 0.1 which results in 1.6.
